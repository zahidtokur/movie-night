...
URL_DICT = {
    ...
    "Aksiyon":{
        "FIRST":"https://www.imdb.com/search/title?title_type=feature&num_votes=25000,&genres=action&view=simple&sort=user_rating,desc&ref_=adv_prv",
...
def pick_movie(genre,rating):
    # eğer kullanıcının istediği minimum rating, o film türündeki maksimum puandan fazlaysa
    if rating > URL_DICT[genre]["MAX_RATING"]:
        return -1,-1,-1

    # istenen kriterlere uyan bütün filmleri çek
    ...
    # rastgele birini seçip İsim, Puan, Yapım Yılı olarak dönder
